...
const ftd = [{
  ...
  //  南風館 ftd[1]
  {
    ...
    beacons: ['801-52342-28213', '801-50788-41017'],
    questions: [{
      question: '請問「南風館」的跟其他哪個展館在相同的位置呢?',
      options: [
        '主題館',
        '生活館',
        '藝陣館',
  ...
  //  工藝館 ftd[2]
  {
    ...
    questions: [{
      ...
      question: '請問工藝中心，近年來透過哪些材料，滲透工藝的營養液到臺南的土壤?',
      options: [
        '竹',
        '纖維',
        '漆',
  ...
  //  新銳館 ftd[3]
  {
    ...
    questions: [{
      question: '請問「新銳館」所在的藍晒圖文創園區呼應了展場的何種主題?',
      options: [
        '篳路藍縷',
        '青出於藍',
        '藍田生玉',
      ...
      question: '請問「新銳館」邀請了多少位新銳設計師/設計品牌前往展出?',
      options: [
        '5~10位',
        '11~20位',
        '21~30位',
  ...
  //  國際館 ftd[4]
  {
    ...
    questions: [{
      question: '請問「國際館」邀請了哪個國家的設計師，探討當初在台灣上的活動?',
      options: [
        '葡萄牙人',
        '荷蘭人',
        '日本人',
  ...
  //  生活館 ftd[6]
  {
    ...
    questions: [{
      ...
      {
        question: '請問「生活館」展覽主題以設計與藝術的過渡為主要策展理念，扣合「生活」發想主題，並以何字作為串聯?',
        options: [
          '度',
          '過',
          '穿',
  ...
  //  體驗館 ftd[7]
  {
    ...
    questions: [{
        question: '「體驗館」分為「觀光工廠 — 自在遊」及「時尚靜態展」展示，請問觀光工廠共有幾大主題?',
        options: [
          '3',
          '4',
          '5',
      ...
      {
        question: '「體驗館」分為「觀光工廠 — 自在遊」及「時尚靜態展」展示，請問時尚靜態展以何者作為主題?',
        options: [
          'dear',
          'DIY',
          'wear',
